                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT notes.*,tblstudents.FullName 
                                                          from  notes
                                                          join tblstudents
                                                          on tblstudents.StudentId=notes.student_id
                                                          order by date DESC";
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {               ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><?php echo htmlentities($result->notes); ?></td>
