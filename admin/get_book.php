...
if (!empty($_POST["bookid"])) {
  ...
  $sql = "SELECT distinct tblbooks.BookName,tblbooks.id,tblauthors.AuthorName,tblbooks.bookImage,tblbooks.isIssued ,tblbooks.count,
    tblbooks.issued_count
    FROM tblbooks
        ...
        <?php foreach ($results as $result) { ?>
          <th style="padding-left:5%; width: 10%;">
            ...
            <?php else : ?>
              ...
              <input type='hidden' name='issued_count' value="<?php echo htmlentities($result->issued_count); ?>" required='required' />
            <?php endif; ?>
          </th>
