        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">STUDENTS DIDN'T RETURN ISSUED BOOKS on time</h4>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = " SELECT tblstudents.StudentId,tblstudents.FullName, tblstudents.EmailId,
                                            tblstudents.MobileNumber,tblstudents.RegDate,tblstudents.Status,tblstudents.id,
                                            tblissuedbookdetails.* FROM tblissuedbookdetails 
                                                   LEFT JOIN tblstudents ON tblissuedbookdetails.StudentID = tblstudents.StudentId 
                                                   where (tblissuedbookdetails.RetrunStatus='' || tblissuedbookdetails.RetrunStatus is null) 
                                                   AND due_date <:date
                                                   GROUP BY tblstudents.StudentId, tblstudents.FullName";
                                            $query = $dbh->prepare($sql);
