...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $sql = "INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,cat1,cat2,publishing_house,count,issued_count) 
            VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:category1,:category2,:publish,:count,:issued_count)";
                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="publish" autocomplete="off" required="required" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="count" autocomplete="off" required="required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
