...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update  admin set FullName=:fullname,AdminEmail=:email,UserName=:username,Password=:password,updationDate=:updatedate where id=:adminid";
        ...
        $query->execute();
        $_SESSION['updatemsg'] = "Admin info updated successfully";
    ...
    <div class=" content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Edit Admin</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {               ?>
                                            ...
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input class="form-control" type="email" name="email" value="<?php echo htmlentities($result->AdminEmail); ?>" required />
                                            </div>
                                            <div class="form-group">
